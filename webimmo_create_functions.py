...
#curl -X POST "http://localhost:5000/api-web-immo/v1.0/create_good/?user_id=theobens&password=arcane&good_id=mygood1&good_name=quietstudio&description=20m2studio&type=studio&city=paris&rooms=2&caracteristics=parking"